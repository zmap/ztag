...
ztag_http = SubRecord({
    ...
    "body":HTML(),
    "tls_initial": ztag_tls_type(doc="The TLS handshake of the initial target (if applicable)"),
    "tls": ztag_tls_type(doc="The TLS handshake of the final response after following all redirects (if present)"),
