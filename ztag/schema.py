...
zgrab_http_headers = SubRecord({
    "access_control_allow_origin":ListOf(CensysString()),
    "accept_patch":ListOf(CensysString()),
    "accept_ranges":ListOf(CensysString()),
    "age":ListOf(CensysString()),
    "allow":ListOf(CensysString()),
    "alt_svc":ListOf(CensysString()),
    "alternate_protocol":ListOf(CensysString()),
    "cache_control":ListOf(CensysString()),
    "connection":ListOf(CensysString()),
    "content_disposition":ListOf(CensysString()),
    "content_encoding":ListOf(CensysString()),
    "content_language":ListOf(CensysString()),
    "content_length":ListOf(CensysString()),
    "content_location":ListOf(CensysString()),
    "content_md5":ListOf(CensysString()),
    "content_range":ListOf(CensysString()),
    "content_type":ListOf(CensysString()),
    "date":ListOf(CensysString()),
    "etag":ListOf(CensysString()),
    "expires":ListOf(CensysString()),
    "last_modified":ListOf(CensysString()),
    "link":ListOf(CensysString()),
    "location":ListOf(CensysString()),
    "p3p":ListOf(CensysString()),
    "pragma":ListOf(CensysString()),
    "proxy_authenticate":ListOf(CensysString()),
    "public_key_pins":ListOf(CensysString()),
    "refresh":ListOf(CensysString()),
    #"referer":ListOf(CensysString()), // TODO: Why is this commented out?
    "retry_after":ListOf(CensysString()),
    "server":ListOf(CensysString()),
    "set_cookie":ListOf(CensysString()),
    "status":ListOf(CensysString()),
    "strict_transport_security":ListOf(CensysString()),
    "trailer":ListOf(CensysString()),
    "transfer_encoding":ListOf(CensysString()),
    "upgrade":ListOf(CensysString()),
    "vary":ListOf(CensysString()),
    "via":ListOf(CensysString()),
    "warning":ListOf(CensysString()),
    "www_authenticate":ListOf(CensysString()),
    "x_frame_options":ListOf(CensysString()),
    "x_xss_protection":ListOf(CensysString()),
    "content_security_policy":ListOf(CensysString()),
    "x_content_security_policy":ListOf(CensysString()),
    "x_webkit_csp":ListOf(CensysString()),
    "x_content_type_options":ListOf(CensysString()),
    "x_powered_by":ListOf(CensysString()),
    "x_ua_compatible":ListOf(CensysString()),
    "x_content_duration":ListOf(CensysString()),
    #"x_real_ip":ListOf(CensysString(doc="overloaded X-Real-IP in our proxy testing so that "\
    #                       "our scanner can detect who made the request.")),
    "proxy_agent":ListOf(CensysString()),
